...
return (
<h1  className='my-4 flex gap-2 items-center justify-center'>
<svg onClick={(e)=>{copytxt(e)}} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6"  >
